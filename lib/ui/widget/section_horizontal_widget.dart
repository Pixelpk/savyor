...
class SectionHorizontalWidget extends BaseStateLessWidget {
  ...
  SectionHorizontalWidget({Key? key, this.gap, required this.firstWidget, required this.secondWidget, this.thirdWidget,this.mainAxisAlignment}) : super(key: key);
  ...
  Widget build(BuildContext context) {
   ...
   List<Widget> child = thirdWidget!=null ? [firstWidget, _gap.horizontalBoxPadding(), secondWidget,  _gap.horizontalBoxPadding(), thirdWidget!]: [firstWidget, _gap.horizontalBoxPadding(), secondWidget];
    return Row(
