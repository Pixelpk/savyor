    ...
    return DefaultTabController(
        ...
        child: Scaffold(
            body: PageView(
                ...
                children: [
                  BrowserMainPage(),
                  ChangeNotifierProvider(create: (_) => MyListViewModel(), child: MyList()),
                  AccountScreen()
                ]),
                ...
                child: Material(
                    ...
                    child: ClipRRect(
                        ...
                        child: BottomNavigationBar(
                            ...
                            selectedLabelStyle:
                                context.textTheme.subtitle2?.copyWith(fontFamily: 'DM Sans', height: 1.5),
                            ...
                            items: [
                              BottomNavigationBarItem(
                                  label: 'Browse',
                                  icon: Assets.browser(Style.accentColor),
                                  activeIcon: Assets.browser(Style.primaryColor)),
                              BottomNavigationBarItem(
                                  label: 'My List',
                                  icon: Assets.list(Style.accentColor),
                                  activeIcon: Assets.list(Style.primaryColor)),
                              BottomNavigationBarItem(
                                  label: 'Account',
                                  icon: Assets.user(Style.accentColor),
                                  activeIcon: Assets.user(Style.primaryColor))
                            ]))))));
  }
}
