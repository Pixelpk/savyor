                                ...
                                child: Column(children: [
                                  SectionVerticalWidget(
                                      ...
                                      secondWidget: Text.rich(TextSpan(
                                          ...
                                          children: const [
                                            TextSpan(text: '      '),
                                            TextSpan(text: 'shop online and save')
                                          ]))),
                                  ...
                                  SectionVerticalWidget(
                                    ...
                                    secondWidget: SectionTextField(
                                      ...
                                      validator: (e) {
                                        if (e != null &&
                                            e.trim().isNotEmpty &&
                                            password.text.trim() == name.text.trim()) {
                                          return null;
                                        }
                                  ...
                                  SectionVerticalWidget(
                                      ...
                                      firstWidget: BigBtn(
                                        onTap: () {
                                          if (validated) {
                                            final PasswordEntity params = PasswordEntity(
                                                password: password.text.trim(), confirmPassword: name.text.trim());
